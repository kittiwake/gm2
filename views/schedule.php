<div class="content">
    <table class="plan">
        <?php for($W = -1; $W < $nW+1; $W++): ?>
            <tr>
                <?php for($w=1; $w<7; $w++):
                    $wd = $w-1;
                    $day_date = strtotime('last Monday +'.$W.' week +'.$wd.'day');
                    ...
                    <td>
                        <table class="oneday">
                            ...
                            foreach($orderList[$W.'-'.$w] as $day):?>
                                ...
                                $sign = '';
                                if ($day['rassr'] == 1) $sign = '<img class="rad" src="/'.SITE_DIR.'/images/rassr.jpg">';
                                if ($day['beznal'] == 1) $sign = '<img class="rad" src="/'.SITE_DIR.'/images/bank.jpg">';
                                if ($day['term']=='0000-00-00'){
                                    $date = '<img src="/'.SITE_DIR.'/images/otkr.png">';
                                }else{
                                ...
                                <tr>
                                    <td rowspan="2" bgcolor="<?=$cbgcol;?>" style="color: #<?=$ctcol;?>"><?=$contract;?></td>
                                    <td class="summa" bgcolor="<?=$cbgcol;?>"><?php echo $sign.' '.$day['sum']; ?>р.</td>
                                </tr>
                                <tr>
