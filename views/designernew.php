                    ...
                    <table>
                        ...
                        <?php foreach($sample_zakl as $zakl):?>
                            <tr>
                                ...
                                <td id="<?=$zakl['id']?>"><?=$zakl['contract']?></td>
                                <td><?=$zakl['address']?></td>
                                <td class="tdnote">
                    ...
                    <table>
                        ...
                        <?php foreach($sample_plan as $sample):?>
                            <tr>
                                ...
                                <td id="<?=$sample['id']?>" style="background-color: <?=$sample['render']=='money'?'gold':($sample['render']=='contract'?'tomato':'inherit');?>"><?=$sample['contract']?></td>
