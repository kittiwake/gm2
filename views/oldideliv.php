                                ...
                                if($mater['otdel']=='o'):?>
                                    <tr id="tr<?=$mater['id']?>" data-materid="<?=$mater['id']?>" data-logistid="<?=$mater['logist_id']?>"  data-con="<?=$contract?>">
                                        ...
                                        <td class="prov" data-prov="<?=$mater['prov_id']?>">
                                            <select class="deliv-select prov_<?=$mater['catid']?>">
                                        ...
                                        <td style="position: relative">
                                            ...
                                            <!--<input type='date' size='10' class="deliv-input_date" data-pole="plan_date" value="<?=$mater['plan_date']=='0000-00-00'?'':preg_replace('/(\d{4})-(\d{2})-(\d{2})/','$3-$2-$1',$mater['plan_date'])?>">-->
                                        </td>
                                        <!--                            --><?php //if($ri==8):?>
                                        <td>
