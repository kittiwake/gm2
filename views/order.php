...
<div id="od">
    <h2>Договор № <strong><?=$order['contract'];?></strong> от <?php echo date ("d.m.Y",strtotime($order['contract_date']));?>    </h2>
    ...
    <div class="right">
        <div class="oder">
            ...
            <br />
            <ins><em>Сумма договора</em></ins> <?=$order['sum'];?>р.<br />
            <br />
        ...
        <div class="farm">
            ...
            <p><ins><em>Дизайнер</em></ins> <?=$dis;?><br />
                <br />
                <ins><em>Технолог</em></ins> <?=$tech;?><br />
                <br />
   <!--         <div class="buttonod"  onclick="">
                В папку с файлами
            </div>-->
